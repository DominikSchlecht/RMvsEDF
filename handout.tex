...
%		pdfstartview=Fit,			% Modus beim Öffnen (Fit = An Seitengröße anpassen)
		pdftitle={Rate Monotonics vs. Erliest Deadline First},
...
%\ohead{\headmark}
\ihead{Rate Monotonics vs. Erliest Deadline First}
...
\begin{document}
	...
	\section{Einleitung}
	\input{handout/einleitung.tex}
	
	\section{Rate Monotonic \& Erliest Deadline First}
	\input{handout/rmAndEdf.tex}
	
	\section{Vergleich}
	\input{handout/vergleich.tex}
